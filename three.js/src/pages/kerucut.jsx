...
const navigation = [
  ...
  { name: 'Kerucut', href: '/kerucut', current: true },
...
export default function Kerucut() {
  ...
  useEffect(() => {
    ...
    const kerucut = new THREE.Mesh(geometry, material)
    scene.current.add(kerucut)

    camera.position.z = 5
    function animate() {
      requestAnimationFrame(animate)
      kerucut.rotation.x += 0.01
      kerucut.rotation.y += 0.01
  ...
  return (
    <div className='bg-gray-800 flex flex-col items-center justify-center min-h-screen py-2'>
      <Head>
        <title>Kerucut - Tugas Three.js - Zydhan - Grafika Komputer A</title>
        <link rel='icon' href='/favicon.ico' />
        <script src='https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js'></script>
        <meta
          property='og:title'
          content='Kerucut - Tugas Three.js - Zydhan - Grafika Komputer A'
        />
        <meta property='og:type' content='website' />
        <meta
          property='og:url'
          content='https://cg2021a.github.io/tugas-1-zydhanlinnar11/three.js/kerucut'
        />
      </Head>
