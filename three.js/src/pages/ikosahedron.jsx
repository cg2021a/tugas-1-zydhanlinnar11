...
const navigation = [
  ...
  { name: 'Ikosahedron', href: '/ikosahedron', current: true },
...
export default function Ikosahedron() {
  ...
  return (
    <div className='bg-gray-800 flex flex-col items-center justify-center min-h-screen py-2'>
      <Head>
        <title>
          Icosahedron - Tugas Three.js - Zydhan - Grafika Komputer A
        </title>
        ...
        <meta
          property='og:url'
          content='https://cg2021a.github.io/tugas-1-zydhanlinnar11/three.js/ikosahedron'
        />
      </Head>
